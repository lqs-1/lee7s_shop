...
export default {
  ...
  methods: {
    ...
    handleDelete(index, data) {
      this.httpRequest.post("/back/sysDict/deleteDict/" + data.id).then(response => {
        this.changeCurrentPageHandler(1)
      })
    },
    ...
    editDict() {
      ...
      this.httpRequest.post("/back/sysDict/editDict", this.currentDict).then(response => {
        this.changeCurrentPageHandler(1)
        this.currentDict = {}
        this.dictEditVisible = false
      })
    ...
    changeCurrentPageHandler(currentPage) {
      ...
      if (this.type == 0 || (this.parentId != "" && this.type == 1)) {
        this.httpRequest.get("/back/sysDict/selectDict?page=" + currentPage +
    ...
    addDict() {
      ...
      this.httpRequest.post('/back/sysDict/addDict', params)
          .then((response) => {
    ...
    getAllParentDict() {
      ...
      this.httpRequest.get('/back/sysDict/parentSysDictList')
          .then((response) => {
