...
//                .groupName("分布式任务系统") // 如果配置多个文档的时候，那么需要配置groupName来分组标识
                ...
                .apis(RequestHandlerSelectors.basePackage("com.lee7s.shop.back.controller"))
...
//                .build();
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("huaxianren") //  可以用来自定义API的主标题
                .description("商店后台管理系统") // 可以用来描述整体的API
                .termsOfServiceUrl("https://admin.nobibibi.top") // 用于定义服务的域名
