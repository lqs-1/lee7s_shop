package com.lee7s.shop.back.cloud.storage.abs.upload;


import com.lee7s.shop.back.cloud.storage.abs.FileStorageAbs;
import com.lee7s.shop.back.cloud.storage.abs.auto.MinioProperties;
import com.lee7s.shop.back.cloud.storage.abs.auto.OssProperties;
import com.lee7s.shop.back.cloud.storage.abs.auto.QiniuProperties;
import com.lee7s.shop.back.cloud.storage.abs.auto.UploadProperties;
import com.lee7s.shop.back.cloud.storage.abs.exception.FileUploadClientConfigException;
import com.lee7s.shop.back.cloud.storage.abs.utils.MinioFileStorage;
import com.lee7s.shop.back.cloud.storage.abs.utils.OssFileStorage;
import com.lee7s.shop.back.cloud.storage.abs.utils.QiniuFileStorage;
import lombok.Data;
