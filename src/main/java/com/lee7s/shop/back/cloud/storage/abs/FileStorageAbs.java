package com.lee7s.shop.back.cloud.storage.abs;

import com.lee7s.shop.back.cloud.storage.abs.exception.FIleLocalDealErrorException;
import com.lee7s.shop.back.cloud.storage.abs.exception.FIleLocalUpErrorException;
import com.lee7s.shop.back.cloud.storage.abs.itfce.FileStorage;
import com.lee7s.shop.back.cloud.storage.abs.utils.result.LocalFileResult;
import com.lee7s.shop.back.cloud.storage.abs.utils.result.ScaleResult;
